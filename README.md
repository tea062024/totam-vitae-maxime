...
### Install
`npm i @tea062024/totam-vitae-maxime`
...
```javascript
const {CStructBE,CStructLE, hexToBuffer, AtomTypes} = require('@tea062024/totam-vitae-maxime');
...
**Make example**<br>
```typescript
import { CStructBE, CStructProperty } from '@tea062024/totam-vitae-maxime';
...
```typescript
import { CStructBE, CStructClass } from '@tea062024/totam-vitae-maxime';
...
### [Many examples are in this folder '/examples'](https://github.com/tea062024/totam-vitae-maxime/tree/main/examples)

### Basic examples
```typescript
import { CStructBE } from '@tea062024/totam-vitae-maxime';
...
**NOTE** Take a look on ['/examples/decorators.ts'](https://github.com/tea062024/totam-vitae-maxime/tree/main/examples/decorators.ts)
...
```typescript
import { CStructBE, CStructClass, CStructModelProperty } from '@tea062024/totam-vitae-maxime';
...
### [TODO](https://github.com/tea062024/totam-vitae-maxime/blob/main/doc/TODO.md)
